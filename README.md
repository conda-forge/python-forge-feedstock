...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-forge-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12554&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-forge-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-forge` can be installed with:

```
conda install python-forge
```

It is possible to list all of the versions of `python-forge` available on your platform with:
